...
const commands = [
    ...
    },
    {
        ...
        description: "Print debugging information (current cache status and automatically discovered version of prettier for the provided file path, for example `prettierd --debug-info src/my-file.js`).",
    },
    {
        command: "flush-cache\t",
