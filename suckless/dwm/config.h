...
#if BAR_PANGO_PATCH
static const char font[]                 = "Scientifica 10";
#else
...
// Powermenu
static const char *powermenu[] = {"/home/camilo/.local/bin/powermenu",  NULL};

// Screnshot
static const char *screenshot[] = {"/usr/bin/flameshot", "gui", NULL};
static const char *quickshot[] = {"/home/camilo/.local/bin/takeshot", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY,             					PrintScreenDWM,     spawn,             {.v = quickshot } },
	// Volume Keys
